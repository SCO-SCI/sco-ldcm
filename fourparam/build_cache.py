...
def main() -> int:
    ...
    # Row-count invariants (rows kept per source file):
    #   CB2011 tableeq5.dat: four-parameter (Eq.5), Least-Square, xi = 2 km/s.
    #     Option B keep-rule = all ATLAS filters (176985 rows) + CB2011 PHOENIX
    #     for CoRoT/Spitzer only (140 rows; Spitzer has no PHOENIX, so this is
    #     CoRoT alone). Total = 177125.
    #   CS2023 Eq.3 (M2) files: PHOENIX-COND, solar, xi = 2 km/s -> 823 each.
    expected = {
